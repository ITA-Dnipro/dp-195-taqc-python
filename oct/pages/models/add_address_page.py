...
class AddAddressForm(Form):
    contains = {
        ...
        'company': {
            'locator': ('ID', 'input-company'),
            'class': InputField
        },
        'address_1': {
            'locator': ('ID', 'input-address-1'),
            'class': InputField
        },
        'address_2': {
            'locator': ('ID', 'input-address-2'),
            'class': InputField
        },
        'city': {
            'locator': ('ID', 'input-city'),
            'class': InputField
        },
        'post_code': {
            'locator': ('ID', 'input-postcode'),
            'class': InputField
        },
        'country': {
            'locator': ('ID', 'input-country'),
            'class': DropDown
        },
        'region_state': {
            'locator': ('ID', 'input-zone'),
            'class': DropDown
        },
        'default_address': {
