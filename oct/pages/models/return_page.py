...
class Reason(RadioButtonGroup):
    ...
    contains = {
        "dead": {"locator": ("TAG_NAME", "input"), "class": RadioButton},
        "faulty": {
            "locator": (
                "XPATH",
                '//*[@id="content"]/form/fieldset[2]/div[4]/div/div[2]/label/input',
            ),
            "class": RadioButton,
        },
        "error": {
            "locator": (
                "XPATH",
                '//*[@id="content"]/form/fieldset[2]/div[4]/div/div[3]/label/input',
            ),
            "class": RadioButton,
        },
        "other": {
        ...
        "wrong": {
            "locator": (
                "XPATH",
                '//*[@id="content"]/form/fieldset[2]/div[4]/div/div[5]/label/input',
            ),
            "class": RadioButton,
        },
    }
...
class OrderInfo(Block):
    ...
    contains = {
        ...
        "order_id": {"locator": ("ID", "input-order-id"), "class": InputField},
        "order_date": {"locator": ("ID", "input-date-ordered"), "class": InputField},
    }
...
class ProductInfo(Block):
    ...
    contains = {
        "name": {"locator": ("ID", "input-product"), "class": InputField},
        "code": {"locator": ("ID", "input-model"), "class": InputField},
        "quantity": {"locator": ("ID", "input-quantity"), "class": InputField},
        "reason": {
        ...
        "details": {"locator": ("ID", "input-comment"), "class": InputField},
    }
